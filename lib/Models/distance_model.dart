...
//
//     final Distancemodels = DistancemodelsFromJson(jsonString);

import 'dart:convert';

Distancemodels DistancemodelsFromJson(String str) =>
    Distancemodels.fromJson(json.decode(str));

String DistancemodelsToJson(Distancemodels data) => json.encode(data.toJson());

class Distancemodels {
  Distancemodels({
  ...
  factory Distancemodels.fromJson(Map<String, dynamic> json) => Distancemodels(
